...
int main(void){
    ...
    char** currentLevel = lire_fichier("./niveaux/niveau1.txt");
    taille_fichier("./niveaux/niveau1.txt", &tailleY, &tailleX);
    ...
    sols[0] = charger_image("./ressources/sky.bmp", rendu);
    sols[1] = charger_image("./ressources/bricks.bmp", rendu);
    sols[2] = charger_image("./ressources/blueBricks.bmp", rendu);
